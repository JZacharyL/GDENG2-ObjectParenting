...
void TexturedVertexBuffer::load(void* vertexList, UINT vertexSize, UINT listSize, void* shaderByteCode, UINT byteShaderSize)
{
	...
	ID3D11Device* directXDevice = GraphicsEngine::get()->getDirectXDevice();
	...
	HRESULT layoutResult = directXDevice->CreateInputLayout(layout, layoutSize, shaderByteCode, byteShaderSize, &this->m_layout);
